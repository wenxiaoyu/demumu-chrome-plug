...
| 1    | 记录今日敲击次数                 | 例如：15 次                               |          | ⬜   |
| 2    | 修改系统时间到明天               | 时间改变                                  |          | ⬜   |
| 3    | 重新打开 Popup（无需重启浏览器） | 今日敲击次数重置为 0                      |          | ⬜   |
| 4    | 检查总计敲击                     | 总计保持为 15                             |          | ⬜   |
| 5    | 检查 HP                          | HP 减少 10（时间惩罚）                    |          | ⬜   |
| 6    | 检查 Console                     | 显示"Day changed, reset todayKnocks to 0" |          | ⬜   |

**注意**: ✅ BUG-001 已修复 - 无需重启浏览器即可自动重置
