    ...
    <div className="popup-container">
      ...
      <main className="popup-main">
        ...
        <div className="stats-bar">
          <StatCard icon="📅" label={t('today')} value={userData.todayKnocks} color="#239a3b" />
          <StatCard icon="🙏" label={t('merit')} value={userData.merit} color="#d4a574" />
          <StatCard icon="📊" label={t('total')} value={userData.totalKnocks} color="#7bc96f" />
        </div>
      </main>
      ...
      <footer className="popup-footer">
        ...
        <button
          className="help-btn"
          onClick={() =>
            chrome.tabs.create({ url: chrome.runtime.getURL('src/options/index.html?tab=help') })
          }
          title={t('help')}
        >
          ❓
